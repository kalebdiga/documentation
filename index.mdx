...
<CardGroup cols={2}>
  ...
  <Card title="Player statistics" icon="chart-bar" href="/api-reference/endpoint/get-player-statistics">
    Fetch QB, offensive, defensive, punt, and return stats for one schedule — with `teamId` / `teamName` on each row.
  </Card>
...
sequenceDiagram
  ...
  App->>API: GET /v1/blitz-api/schedules/:scheduleId/player-statistics
```
